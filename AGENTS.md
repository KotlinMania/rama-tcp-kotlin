...
This file is the quick-reference operating contract for rama-tcp-kotlin. The longer
...
rama-tcp-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`rama-tcp`](https://crates.io/crates/rama-tcp). Upstream Rust is the behavioral oracle while the
