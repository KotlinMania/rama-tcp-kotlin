...
kotlin {
    ...
    val xcf = XCFramework("RamaTcp")

    macosArm64 {
        binaries.framework { baseName = "RamaTcp"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RamaTcp"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RamaTcp"
        flattenPackage = "io.github.kotlinmania.ramatcp"
    }

    android {
        namespace = "io.github.kotlinmania.ramatcp"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "rama-tcp-kotlin", version.toString())

    pom {
        name.set("rama-tcp-kotlin")
        description.set("Kotlin Multiplatform port of plabayo/rama - TCP support for rama")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/rama-tcp-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/rama-tcp-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/rama-tcp-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/rama-tcp-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleRamaTcpXCFramework",
    "assembleRamaTcpDebugXCFramework",
    "assembleRamaTcpReleaseXCFramework",
    "assembleDebugIosFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseIosFatFrameworkForRamaTcpXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForRamaTcpXCFramework",
    "assembleDebugMacosFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseMacosFatFrameworkForRamaTcpXCFramework",
    "assembleDebugTvosFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseTvosFatFrameworkForRamaTcpXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForRamaTcpXCFramework",
    "assembleDebugWatchosFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseWatchosFatFrameworkForRamaTcpXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForRamaTcpXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForRamaTcpXCFramework",
